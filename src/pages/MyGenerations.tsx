...
function MyGenerations() {
  ...
  return loading ?  (
    ...
    <div className="min-h-screen text-white p-6 md:p-12 my-28">
      <div className="max-w-6xl ma-auto">
    <header className="mb-12">
      <h1 className="text-3xl md:text-4xl font-semibold mb-4">My Generations</h1>
      <p className="text-gray-400">View and manage your AI-geenerated content</p>
    </header>
    ...
    {generations.length === 0 && (
      <div className="text-center py-20 bg-white/5 rounded-xl border border-white/10">
        ...
        <PrimaryButton onClick={()=>window.location.href = '/generator'}>
