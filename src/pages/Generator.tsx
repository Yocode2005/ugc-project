...
function Generator() {
  ...
  return (
    <div className="min-h-screen text-white p-6 mid:p-12 mt-28">
      <form onSubmit={handleGenerate} className="max-w-4xl max-auto mb-40">
        <Title heading="Create In-Context Image"  description="Upload your model and product images to generate stunnig UGC, short-form videos and social media posts"/>
        <div className="flex gap-20 max-sm:flex-col items-start justify-between">
          {/* Left col */}
          <div className="flex flex-col w-full sm:max-w-60 gap-8 mt-8 md-12">
          ...
          <div  className="w-full">
           ...
           <textarea  id="userPrompt"  rows={4} value={userPrompt} onChange={(e)=>setUserPrompt(e.target.value)} placeholder="Describe how you want to narration to be" className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all"/>
           </div>
          </div>
        </div>
